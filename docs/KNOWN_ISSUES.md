...
No quedan incidencias técnicas abiertas específicas del Laboratorio ChatGPT Voice — experiencia Live. Las inspecciones visuales de ambos DOCX fueron aprobadas y la guía de preparación quedó corregida y sincronizada con su PDF. El controlador de redimensionamiento observado en Word es un elemento de interfaz y no forma parte del PDF. La disponibilidad de Voice, Live, Advanced, Standard, cámara, pantalla, segundo plano e integración con Work o Codex continúa condicionada por plan, cuenta, región, aplicación, permisos y configuración; esta condición está documentada como limitación del producto.
...
## Colección Académica — recursos pendientes

No hay incidencias funcionales en la estructura web. Permanecen pendientes los seis PDF definitivos; por transparencia, no existen enlaces de descarga activos ni portadas extraídas de archivos inexistentes.
